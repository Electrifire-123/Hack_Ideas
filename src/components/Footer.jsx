...
function Footer() {
    return (
      <div className=''>
          <div className="bg-gray-100 dark:bg-gray-800 dark:border-gray-600 ">
              <div className="max-w-screen-lg px-4 sm:px-6 text-gray-800 dark:text-white sm:grid md:grid-cols-4 sm:grid-cols-2 mx-auto">
                  <div className="p-5">
                      <h3 className="font-bold text-xl text-indigo-600">Hack Ideas</h3>
                  </div>
                  <div className="p-5">
                  ...
                  <div className="p-5">
                      ...
                      <a className="my-3 block" href="/#">XXX XXXX, Akola, 44003, Maharashtra, India
                          <span className="text-teal-600 text-xs p-1"></span></a><a className="my-3 block" href="/#">contact@hackideas.com
                          <span className="text-teal-600 text-xs p-1"></span></a>
                  </div>
              </div>
          </div>
  
          <div className="bg-gray-100 dark:bg-gray-800 dark:border-gray-600  pt-2">
              <div className="flex pb-5 px-3 m-auto pt-5 border-t text-gray-800 dark:text-white text-sm flex-col
              max-w-screen-lg items-center">
                  <div className="md:flex-auto md:flex-row-reverse mt-2 flex-row flex">
                      <a href="/#" className="w-6 mx-1">
                          <svg className="fill-current cursor-pointer text-gray-500 dark:text-slate-200 hover:text-indigo-600" width="100%" height="100%"
                              viewBox="0 0 24 24" version="1.1" xmlns="http://www.w3.org/2000/svg"
                              xmlnsXlink="http://www.w3.org/1999/xlink" xmlSpace="preserve" xmlLang="http://www.serif.com/"
